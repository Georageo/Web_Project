...
document.addEventListener("DOMContentLoaded", function(){
    ...
    const button14=document.getElementById("rent_the_car1");
    button14.addEventListener("click",function(){
        const car_id_con = 4;
        localStorage.setItem('car_id',car_id_con);
        window.location.href = '/car_details';
    })
    const button15=document.getElementById("rent_the_car2");
    button15.addEventListener("click",function(){
        const car_id_con = 5;
        localStorage.setItem('car_id',car_id_con);
        window.location.href = '/car_details';
    })
    const button16=document.getElementById("rent_the_car3");
    button16.addEventListener("click",function(){
        const car_id_con = 1;
        localStorage.setItem('car_id',car_id_con);
        window.location.href = '/car_details';
    })
    const button17=document.getElementById("rent_the_car4");
